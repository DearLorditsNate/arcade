        ...
        >
          <Carousel.Item>
            <a href="/tetris" className="carousel-text">
              ...
              <h1>Tetris</h1>
              <p className="pb-4">
                Use the arrow keys to move your piece. Use the space bar to
                drop your piece into place.
              </p>
            </a>
          </Carousel.Item>
          <Carousel.Item>
          ...
          <Carousel.Item>
            <a href="/minesweeper" className="carousel-text">
              ...
              />
              <h1>Minesweeper</h1>
              <p className="pb-4">Find the bombs... or else!</p>
            </a>
          </Carousel.Item>
          <Carousel.Item>
            <a href="/battlegame" className="carousel-text">
              <img
                className="d-block w-50 card-img align-center"
                src="https://i.ytimg.com/vi/UCyIRHWBABs/maxresdefault.jpg"
                alt="Second slide"
              />
              <h1>Solitary BattleShip</h1>
              <p className="pb-4">
                Feeling Lucky? How Many Missiles Do You Need to Sink All of
                Your Enemies BattleShips? Click "Send Missle" To Find Out.
              </p>
            </a>
          </Carousel.Item>
        </Carousel>
